...
async def main(bot: Client, message: Message):
    ...
    phone_number_msg = await bot.ask(chat_id=user_id, text="<b>Enter Your Mobile Number With Country Code.\n\n𝘾𝙡𝙞𝙘𝙠 /cancel 𝙏𝙤 𝙂𝙤 𝘽𝙖𝙘𝙠")
    ...
    await bot.send_message(message.from_user.id, "<b>Account Login Successfully.\n\nIf You Get Any Error Related To AUTH KEY Then /disconnect and /connect again</b>")
